...
<body style="width:98%">
	<div class="row">
		<div class="col-xs-12">
			...
			<%-- 	<p:permission privilege="com.mashen.organization.controller.organizationManageController:doAdd"> --%>
			...
			mydatatables = $('#mydatatables').DataTable(
							{
								...
								"columnDefs" : [
										...
										},
										{
											"render" : function(data, type, row) {
												//row.account
												return '<a href="${path }/organization/edit.action?id='+data+'" class="tooltip-success" data-rel="tooltip" title="Edit"><span class="green"><i class="icon-edit bigger-120"></i></a>&nbsp;&nbsp;'
